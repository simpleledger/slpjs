...
module.exports = class BitboxNetwork {
    ...
    static async sendToken(tokenId, sendAmount, fundingAddress, fundingWif, tokenReceiverAddress, changeReceiverAddress){
