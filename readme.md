...
const getRawTransactions = async function(txids) {
  return await BITBOX.RawTransactions.getRawTransaction(txids);
};
...
const fundingAddress =
  "simpleledger:qrhvcy5xlegs858fjqf8ssl6a4f7wpstaqnt0wauwu"; // <-- must be simpleledger format
const fundingWif = "L3gngkDg1HW5P9v5GdWWiCi3DWwvw5XnzjSPwNwVPN5DSck3AaiF"; // <-- compressed WIF format
const tokenReceiverAddress =
  "simpleledger:qrhvcy5xlegs858fjqf8ssl6a4f7wpstaqnt0wauwu"; // <-- must be simpleledger format
const bchChangeReceiverAddress =
  "simpleledger:qrhvcy5xlegs858fjqf8ssl6a4f7wpstaqnt0wauwu"; // <-- cashAddr or slpAddr format
...
(async function() {
  ...
  else throw Error("You don't have the minting baton for this token");
})();
...
const tokenReceiverAddress =
  "slptest:qpwyc9jnwckntlpuslg7ncmhe2n423304ueqcyw80l"; // <-- must be slpAddr format
const bchChangeReceiverAddress =
  "slptest:qpwyc9jnwckntlpuslg7ncmhe2n423304ueqcyw80l"; // <-- cashAddr or slpAddr format
let tokenId =
  "a67e2abb2fcfaa605c6a3b0dfb642cc830b63138d85b5e95eee523fdbded4d74";
let sendAmount = 10;
...
(async function() {
  ...
  console.log(
    "Token balance:",
    balances.slpTokenBalances[tokenId].toNumber() / 10 ** tokenDecimals
  );
})();
...
const BITBOX = new BITBOXSDK({ restURL: "https://rest.bitcoin.com/v2/" });
const fundingAddress =
  "simpleledger:qrhvcy5xlegs858fjqf8ssl6a4f7wpstaqnt0wauwu"; // <-- must be slpAddr format
const fundingWif = "L3gngkDg1HW5P9v5GdWWiCi3DWwvw5XnzjSPwNwVPN5DSck3AaiF"; // <-- compressed WIF format
const bchChangeReceiverAddress =
  "simpleledger:qrhvcy5xlegs858fjqf8ssl6a4f7wpstaqnt0wauwu"; // <-- cashAddr or slpAddr format
let tokenId =
...
let slpAddr = Utils.toSlpAddress(
